...
`}],T=j[0].luau,M=j[0].ts;function C(){let e=function(){let[e,r]=(0,n.useState)("light");return(0,n.useEffect)(()=>{let e=document.documentElement,t=()=>{r("dark"===e.getAttribute("data-theme")?"dark":"light")};t();let a=new MutationObserver(t);return a.observe(e,{attributes:!0,attributeFilter:["data-theme"]}),()=>a.disconnect()},[]),e}(),[r,l]=(0,n.useState)(0),[c,u]=(0,n.useState)(T),[m,p]=(0,n.useState)(M),[d,f]=(0,n.useState)("rbxts"),[b,h]=(0,n.useState)("luauToTs"),[g,w]=(0,n.useState)(""),[x,y]=(0,n.useState)([]),[v,C]=(0,n.useState)(!1),[V,A]=(0,n.useState)("idle"),_=(0,n.useRef)(null),$=(0,n.useRef)(null),L=(0,n.useRef)(null);async function R(){if("luauToTs"===b){let e=_.current;if(e){C(!0);try{let r=await e.compile(c,{compatMode:d});w(r.source),y(r.errors??[])}catch(e){y([{message:e.message}]),w("")}finally{C(!1)}}}else{let e=$.current;if(!e||"ready"!==V)return;C(!0),e.postMessage({type:"compile",source:m})}}(0,n.useEffect)(()=>{let e=!1;return(async()=>{try{let r=await Promise.all([t.e("847"),t.e("202")]).then(t.bind(t,2641));e||(_.current=r),e||"luauToTs"!==b||R()}catch(r){e||y([{message:`Failed to load Luau\u{2192}TS compiler: ${r.message}`}])}})(),()=>{e=!0}},[]),(0,n.useEffect)(()=>{if("tsToLuau"!==b)return;if($.current&&"ready"===V)return void R();if("loading"===V)return;A("loading");let e=!1;return(async()=>{try{let r=new Worker("/rbxts-worker.js");if(r.addEventListener("message",e=>{e.data?.type==="compiled"&&(w(e.data.source),y(e.data.ok?[]:[{message:"roblox-ts compile errors (see output)"}]),C(!1))}),r.addEventListener("error",e=>{y([{message:`Worker error: ${e.message??"unknown"}`}]),A("error"),C(!1)}),$.current=r,await k(r),e)return;A("ready"),R()}catch(r){e||(y([{message:`Failed to spawn TS\u{2192}Luau worker: ${r.message}`}]),A("error"))}})(),()=>{e=!0}},[b]),(0,n.useEffect)(()=>()=>{$.current?.terminate()},[]),(0,n.useEffect)(()=>(L.current&&clearTimeout(L.current),L.current=setTimeout(()=>{R()},150),()=>{L.current&&clearTimeout(L.current)}),[c,m,d,b,V]);let W="dark"===e?s.Zj.dracula:s.Zj.github,G="tsToLuau"===b,B=G?m:c;return(0,a.jsxs)("div",{className:"root_oAx2",children:[(0,a.jsxs)("div",{className:"toolbar_FTq7",children:[(0,a.jsxs)("h1",{className:"title_Nfa7",children:[G?"TypeScript \u2192 Luau":"Luau \u2192 TypeScript"," playground"]}),(0,a.jsxs)("div",{className:"controls_hnU5",children:[(0,a.jsxs)("label",{className:o,children:[(0,a.jsx)("span",{children:"Example:"}),(0,a.jsx)("select",{value:r,onChange:e=>{var r;let t;(t=j[r=Number(e.target.value)])&&(l(r),u(t.luau),p(t.ts))},className:i,children:j.map((e,r)=>(0,a.jsx)("option",{value:r,children:e.name},r))})]}),!G&&(0,a.jsxs)("label",{className:o,children:[(0,a.jsx)("span",{children:"Compat mode:"}),(0,a.jsxs)("select",{value:d,onChange:e=>f(e.target.value),className:i,children:[(0,a.jsx)("option",{value:"native",children:"native (luau2ts/runtime)"}),(0,a.jsx)("option",{value:"rbxts",children:"rbxts (@rbxts/* shim)"})]})]}),(0,a.jsx)("span",{className:"busy_j2FR",children:G&&"loading"===V?"loading roblox-ts + @rbxts/types\u2026":v?"compiling\u2026":""})]})]}),(0,a.jsxs)("div",{className:"panes_olFc",children:[(0,a.jsx)(P,{source:B,label:G?"TypeScript source":"Luau source",lang:G?"tsx":"lua",onChange:G?p:u,prismTheme:W}),(0,a.jsx)("button",{type:"button",onClick:()=>h(e=>"luauToTs"===e?"tsToLuau":"luauToTs"),className:"swap_x44F","aria-label":"Swap direction",title:G?"Switch to Luau \u2192 TypeScript":"Switch to TypeScript \u2192 Luau (loads roblox-ts in a worker)",children:(0,a.jsx)(N,{})}),(0,a.jsx)(S,{output:g,label:G?"Luau output":"TypeScript output",lang:G?"lua":"tsx",errors:x,prismTheme:W})]})]})}function P({source:e,label:r,lang:t,onChange:s,prismTheme:o}){let i=(0,n.useRef)(null),u=(0,n.useRef)(null),m=(0,n.useMemo)(()=>Math.max(1,e.split("\n").length),[e]);return(0,a.jsxs)("div",{className:l,children:[(0,a.jsx)("div",{className:c,children:r}),(0,a.jsxs)("div",{className:"editorWrap_an2x",children:[(0,a.jsx)("div",{className:"editorGutter_NWp0",ref:u,"aria-hidden":!0,children:Array.from({length:m},(e,r)=>(0,a.jsx)("div",{className:"editorGutterLine_Exzz",children:r+1},r))}),(0,a.jsx)("textarea",{ref:i,value:e,onChange:e=>s(e.target.value),onScroll:function(){u.current&&i.current&&(u.current.scrollTop=i.current.scrollTop)},spellCheck:!1,className:"editor_TLlF","aria-label":r})]}),(0,a.jsxs)("span",{style:{display:"none"},children:[t,o.plain?.color??""]})]})}function S({output:e,label:r,lang:t,errors:n,prismTheme:s}){return(0,a.jsxs)("div",{className:l,children:[(0,a.jsx)("div",{className:c,children:r}),(0,a.jsx)(V,{source:e,lang:t,prismTheme:s}),n.length>0&&(0,a.jsx)("div",{className:"errors_GbBP",children:n.map((e,r)=>(0,a.jsxs)("div",{className:"errorRow_vLpB",children:[e.loc?`line ${e.loc.start.line+1}: `:"",e.message]},r))})]})}function N(){return(0,a.jsxs)("svg",{width:"22",height:"22",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,children:[(0,a.jsx)("path",{d:"M7 16V4M7 4L3 8M7 4l4 4"}),(0,a.jsx)("path",{d:"M17 8v12M17 20l-4-4M17 20l4-4"})]})}function V({source:e,lang:r,prismTheme:t}){return(0,a.jsx)(s.f4,{code:e,language:r,theme:t,children:({className:e,style:r,tokens:t,getLineProps:n,getTokenProps:s})=>(0,a.jsx)("pre",{className:`${e} output_KJb5`,style:r,children:t.map((e,r)=>(0,a.jsxs)("div",{...n({line:e}),children:[(0,a.jsx)("span",{className:"lineNum_BdmQ",children:r+1}),e.map((e,r)=>(0,a.jsx)("span",{...s({token:e})},r))]},r))})})}}}]);