...
`}],T=j[0].luau,M=j[0].ts;function C(){let e=function(){let[e,t]=(0,n.useState)("light");return(0,n.useEffect)(()=>{let e=document.documentElement,r=()=>{t("dark"===e.getAttribute("data-theme")?"dark":"light")};r();let a=new MutationObserver(r);return a.observe(e,{attributes:!0,attributeFilter:["data-theme"]}),()=>a.disconnect()},[]),e}(),[t,l]=(0,n.useState)(0),[c,u]=(0,n.useState)(T),[m,p]=(0,n.useState)(M),[d,f]=(0,n.useState)("rbxts"),[h,b]=(0,n.useState)("luauToTs"),[g,w]=(0,n.useState)(""),[x,y]=(0,n.useState)([]),[v,C]=(0,n.useState)(!1),[N,V]=(0,n.useState)("idle"),_=(0,n.useRef)(null),$=(0,n.useRef)(null),L=(0,n.useRef)(null);async function R(){if("luauToTs"===h){let e=_.current;if(e){C(!0);try{let t=await e.compile(c,{compatMode:d});w(t.source),y(t.errors??[])}catch(e){y([{message:e.message}]),w("")}finally{C(!1)}}}else{let e=$.current;if(!e||"ready"!==N)return;C(!0),e.postMessage({type:"compile",source:m})}}(0,n.useEffect)(()=>{let e=!1;return(async()=>{try{let t=await Promise.all([r.e("847"),r.e("202")]).then(r.bind(r,2641));e||(_.current=t),e||"luauToTs"!==h||R()}catch(t){e||y([{message:`Failed to load Luau\u{2192}TS compiler: ${t.message}`}])}})(),()=>{e=!0}},[]),(0,n.useEffect)(()=>{if("tsToLuau"!==h)return;if($.current&&"ready"===N)return void R();if("loading"===N)return;V("loading");let e=!1;return(async()=>{try{let t=new Worker("/rbxts-worker.js");if(t.addEventListener("message",e=>{e.data?.type==="compiled"&&(w(e.data.source),y(e.data.ok?[]:[{message:"roblox-ts compile errors (see output)"}]),C(!1))}),t.addEventListener("error",e=>{y([{message:`Worker error: ${e.message??"unknown"}`}]),V("error"),C(!1)}),$.current=t,await k(t),e)return;V("ready"),R()}catch(t){e||(y([{message:`Failed to spawn TS\u{2192}Luau worker: ${t.message}`}]),V("error"))}})(),()=>{e=!0}},[h]),(0,n.useEffect)(()=>()=>{$.current?.terminate()},[]),(0,n.useEffect)(()=>(L.current&&clearTimeout(L.current),L.current=setTimeout(()=>{R()},150),()=>{L.current&&clearTimeout(L.current)}),[c,m,d,h,N]);let W="dark"===e?s.Zj.dracula:s.Zj.github,F="tsToLuau"===h,G=F?m:c;return(0,a.jsxs)("div",{className:"root_oAx2",children:[(0,a.jsxs)("div",{className:"toolbar_FTq7",children:[(0,a.jsxs)("h1",{className:"title_Nfa7",children:[F?"TypeScript \u2192 Luau":"Luau \u2192 TypeScript"," playground"]}),(0,a.jsxs)("div",{className:"controls_hnU5",children:[(0,a.jsxs)("label",{className:o,children:[(0,a.jsx)("span",{children:"Example:"}),(0,a.jsx)("select",{value:t,onChange:e=>{var t;let r;(r=j[t=Number(e.target.value)])&&(l(t),u(r.luau),p(r.ts))},className:i,children:j.map((e,t)=>(0,a.jsx)("option",{value:t,children:e.name},t))})]}),!F&&(0,a.jsxs)("label",{className:o,children:[(0,a.jsx)("span",{children:"Compat mode:"}),(0,a.jsxs)("select",{value:d,onChange:e=>f(e.target.value),className:i,children:[(0,a.jsx)("option",{value:"native",children:"native (luau2ts/runtime)"}),(0,a.jsx)("option",{value:"rbxts",children:"rbxts (@rbxts/* shim)"})]})]}),(0,a.jsx)("span",{className:"busy_j2FR",children:F&&"loading"===N?"loading roblox-ts + @rbxts/types\u2026":v?"compiling\u2026":""})]})]}),(0,a.jsxs)("div",{className:"panes_olFc",children:[(0,a.jsx)(P,{source:G,label:F?"TypeScript source":"Luau source",lang:F?"typescript":"lua",onChange:F?p:u,prismTheme:W}),(0,a.jsx)("button",{type:"button",onClick:e=>{e.currentTarget.blur(),b(e=>"luauToTs"===e?"tsToLuau":"luauToTs")},className:"swap_x44F","aria-label":"Swap direction",title:F?"Switch to Luau \u2192 TypeScript":"Switch to TypeScript \u2192 Luau (loads roblox-ts in a worker)",children:(0,a.jsx)(A,{})}),(0,a.jsx)(S,{output:g,label:F?"Luau output":"TypeScript output",lang:F?"lua":"typescript",errors:x,prismTheme:W})]})]})}function P({source:e,label:t,lang:r,onChange:s,prismTheme:o}){let i=(0,n.useRef)(null),u=(0,n.useRef)(null),m=(0,n.useMemo)(()=>Math.max(1,e.split("\n").length),[e]);return(0,a.jsxs)("div",{className:l,children:[(0,a.jsx)("div",{className:c,children:t}),(0,a.jsxs)("div",{className:"editorWrap_an2x",children:[(0,a.jsx)("div",{className:"editorGutter_NWp0",ref:u,"aria-hidden":!0,children:Array.from({length:m},(e,t)=>(0,a.jsx)("div",{className:"editorGutterLine_Exzz",children:t+1},t))}),(0,a.jsx)("textarea",{ref:i,value:e,onChange:e=>s(e.target.value),onKeyDown:function(t){let r,a;if("Tab"!==t.key)return;t.preventDefault();let n=t.currentTarget,o=n.selectionStart,i=n.selectionEnd,l=e.slice(0,o);e.slice(o,i);let c=e.slice(i);if(o===i){s(l+"	"+c),requestAnimationFrame(()=>{n.selectionStart=n.selectionEnd=o+1});return}let u=l.lastIndexOf("\n")+1,m=e.slice(0,u),p=e.slice(u,i).split("\n");if(t.shiftKey){let e=0;r=p.map(t=>{if(t.startsWith("	"))return e+=1,t.slice(1);let r=t.match(/^ {1,4}/);return r?(e+=r[0].length,t.slice(r[0].length)):t}).join("\n"),a=-e}else r=p.map(e=>"	"+e).join("\n"),a=p.length;s(m+r+c),requestAnimationFrame(()=>{n.selectionStart=Math.max(u,o+(t.shiftKey?Math.min(0,a):1)),n.selectionEnd=i+a})},onScroll:function(){u.current&&i.current&&(u.current.scrollTop=i.current.scrollTop)},spellCheck:!1,className:"editor_TLlF","aria-label":t})]}),(0,a.jsxs)("span",{style:{display:"none"},children:[r,o.plain?.color??""]})]})}function S({output:e,label:t,lang:r,errors:n,prismTheme:s}){return(0,a.jsxs)("div",{className:l,children:[(0,a.jsx)("div",{className:c,children:t}),(0,a.jsx)(N,{source:e,lang:r,prismTheme:s}),n.length>0&&(0,a.jsx)("div",{className:"errors_GbBP",children:n.map((e,t)=>(0,a.jsxs)("div",{className:"errorRow_vLpB",children:[e.loc?`line ${e.loc.start.line+1}: `:"",e.message]},t))})]})}function A(){return(0,a.jsxs)("svg",{width:"22",height:"22",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,children:[(0,a.jsx)("path",{d:"M7 16V4M7 4L3 8M7 4l4 4"}),(0,a.jsx)("path",{d:"M17 8v12M17 20l-4-4M17 20l4-4"})]})}function N({source:e,lang:t,prismTheme:r}){return(0,a.jsx)(s.f4,{code:e,language:t,theme:r,children:({className:e,style:t,tokens:r,getLineProps:n,getTokenProps:s})=>(0,a.jsx)("pre",{className:`${e} output_KJb5`,style:t,children:r.map((e,t)=>(0,a.jsxs)("div",{...n({line:e}),children:[(0,a.jsx)("span",{className:"lineNum_BdmQ",children:t+1}),e.map((e,t)=>(0,a.jsx)("span",{...s({token:e})},t))]},t))})})}}}]);