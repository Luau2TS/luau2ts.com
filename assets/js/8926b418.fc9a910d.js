"use strict";(self.webpackChunkluau2ts_com=self.webpackChunkluau2ts_com||[]).push([["164"],{4825(e,r,t){t.d(r,{A:()=>s});var a=t(1325);t(489);var n=t(1626);function s({children:e,fallback:r}){return(0,n.A)()?(0,a.jsx)(a.Fragment,{children:e?.()}):r??null}},6882(e,r,t){t.r(r),t.d(r,{default:()=>C});var a=t(1325),n=t(489),s=t(383);let i="modeLabel_Li0e",o="select_MIap",l="pane_ZPzd",c="paneHeader_vQW2",u="@rbxts",m=["types","compiler-types"],p=/\/\/\/\s*<reference path=["']([^"']+)["']\s*\/>/g,d=/\/\/\/\s*<reference types=["']@rbxts\/([^"']+)["']\s*\/>/g,f=/(?:import|export)\s+.+\s+from\s+['"]([^'"]+)['"]/g;function h(e){let r=e.lastIndexOf("/");return r<0?"":e.slice(0,r)}function b(e,r){if(r.startsWith("/"))return r;let t=(e+"/"+r).split("/"),a=[];for(let e of t)""!==e&&"."!==e&&(".."===e?a.pop():a.push(e));return"/"+a.join("/")}function g(e,r){let t=[];for(let a of r.matchAll(e))t.push(a[1]);return t}async function x(e){let r=e.split("/");return r[1]&&!r[1].includes("@")&&(r[1]=`${r[1]}@latest`),fetch(`https://cdn.jsdelivr.net/npm/${r.join("/")}`)}function w(e,r,t){e.worker.postMessage({type:"writeFile",filePath:`/node_modules/${r}`,content:t})}async function y(e,r,t){if(e.loaded.has(t))return;e.loaded.add(t);let a=await x(t);if(404===a.status&&(t=t.slice(0,-5)+"/index.d.ts",a=await x(t)),200!==a.status)return;let n=await a.text(),s=[];for(let a of g(p,n)){let n=b(h(t),a).slice(1);s.push(y(e,r,n))}for(let a of g(f,n))if((a.endsWith(".")||a.endsWith(".."))&&(a+="/index"),a.startsWith(u))s.push(v(e,a.slice(u.length+1)));else{let n=b(h(t),a).slice(1)+".d.ts";s.push(y(e,r,n))}for(let r of g(d,n))s.push(v(e,r));w(e,t,n),await Promise.allSettled(s)}async function v(e,r){if(e.packages.has(r))return;e.packages.add(r);let t=`${u}/${r}`,a=`${t}/package.json`,n=await x(a);if(200!==n.status)return void e.packages.delete(r);let s=await n.json();w(e,a,JSON.stringify(s));let i=b(`/${t}`,s.main??"").slice(1),o=b(`/${t}`,s.types??s.typings??"index.d.ts").slice(1);e.worker.postMessage({type:"setMapping",typingsPath:`/node_modules/${o}`,mainPath:`/node_modules/${i}`}),await y(e,t,o)}async function j(e){let r={worker:e,loaded:new Set,packages:new Set};await Promise.all(m.map(e=>v(r,e)))}let k=[{name:"Animal class",luau:`local Animal = setmetatable({}, {})
...
`}],T=k[0].luau,M=k[0].ts;function C(){let e=function(){let[e,r]=(0,n.useState)("light");return(0,n.useEffect)(()=>{let e=document.documentElement,t=()=>{r("dark"===e.getAttribute("data-theme")?"dark":"light")};t();let a=new MutationObserver(t);return a.observe(e,{attributes:!0,attributeFilter:["data-theme"]}),()=>a.disconnect()},[]),e}(),[r,l]=(0,n.useState)(0),[c,u]=(0,n.useState)(T),[m,p]=(0,n.useState)(M),[d,f]=(0,n.useState)("rbxts"),[h,b]=(0,n.useState)("luauToTs"),[g,x]=(0,n.useState)(""),[w,y]=(0,n.useState)([]),[v,C]=(0,n.useState)(!1),[N,_]=(0,n.useState)("idle"),V=(0,n.useRef)(null),L=(0,n.useRef)(null),$=(0,n.useRef)(null);async function R(){if("luauToTs"===h){let e=V.current;if(e){C(!0);try{let r=await e.compile(c,{compatMode:d});x(r.source),y(r.errors??[])}catch(e){y([{message:e.message}]),x("")}finally{C(!1)}}}else{let e=L.current;if(!e||"ready"!==N)return;C(!0),e.postMessage({type:"compile",source:m})}}(0,n.useEffect)(()=>{let e=!1;return(async()=>{try{let r=await Promise.all([t.e("847"),t.e("202")]).then(t.bind(t,2641));e||(V.current=r),e||"luauToTs"!==h||R()}catch(r){e||y([{message:`Failed to load Luau\u{2192}TS compiler: ${r.message}`}])}})(),()=>{e=!0}},[]),(0,n.useEffect)(()=>{if("tsToLuau"!==h)return;if(L.current&&"ready"===N)return void R();if("loading"===N)return;_("loading");let e=!1;return(async()=>{try{let r=new Worker("/rbxts-worker.js");if(r.addEventListener("message",e=>{e.data?.type==="compiled"&&(x(e.data.source),y(e.data.ok?[]:[{message:"roblox-ts compile errors (see output)"}]),C(!1))}),r.addEventListener("error",e=>{y([{message:`Worker error: ${e.message??"unknown"}`}]),_("error"),C(!1)}),L.current=r,await j(r),e)return;_("ready"),R()}catch(r){e||(y([{message:`Failed to spawn TS\u{2192}Luau worker: ${r.message}`}]),_("error"))}})(),()=>{e=!0}},[h]),(0,n.useEffect)(()=>()=>{L.current?.terminate()},[]),(0,n.useEffect)(()=>($.current&&clearTimeout($.current),$.current=setTimeout(()=>{R()},150),()=>{$.current&&clearTimeout($.current)}),[c,m,d,h,N]);let W="dark"===e?s.Zj.dracula:s.Zj.github,F="tsToLuau"===h,G=F?m:c;return(0,a.jsxs)("div",{className:"root_oAx2",children:[(0,a.jsxs)("div",{className:"toolbar_FTq7",children:[(0,a.jsxs)("h1",{className:"title_Nfa7",children:[F?"TypeScript \u2192 Luau":"Luau \u2192 TypeScript"," playground"]}),(0,a.jsxs)("div",{className:"controls_hnU5",children:[(0,a.jsxs)("label",{className:i,children:[(0,a.jsx)("span",{children:"Example:"}),(0,a.jsx)("select",{value:r,onChange:e=>{var r;let t;(t=k[r=Number(e.target.value)])&&(l(r),u(t.luau),p(t.ts))},className:o,children:k.map((e,r)=>(0,a.jsx)("option",{value:r,children:e.name},r))})]}),!F&&(0,a.jsxs)("label",{className:i,children:[(0,a.jsx)("span",{children:"Compat mode:"}),(0,a.jsxs)("select",{value:d,onChange:e=>f(e.target.value),className:o,children:[(0,a.jsx)("option",{value:"native",children:"native (luau2ts/runtime)"}),(0,a.jsx)("option",{value:"rbxts",children:"rbxts (@rbxts/* shim)"})]})]}),(0,a.jsx)("span",{className:"busy_j2FR",children:F&&"loading"===N?"loading roblox-ts + @rbxts/types\u2026":v?"compiling\u2026":""})]})]}),(0,a.jsxs)("div",{className:"panes_olFc",children:[(0,a.jsx)(S,{source:G,label:F?"TypeScript source":"Luau source",lang:F?"typescript":"lua",onChange:F?p:u,prismTheme:W}),(0,a.jsx)("button",{type:"button",onClick:e=>{e.currentTarget.blur(),b(e=>"luauToTs"===e?"tsToLuau":"luauToTs")},className:"swap_x44F","aria-label":"Swap direction",title:F?"Switch to Luau \u2192 TypeScript":"Switch to TypeScript \u2192 Luau (loads roblox-ts in a worker)",children:(0,a.jsx)(P,{})}),(0,a.jsx)(A,{output:g,label:F?"Luau output":"TypeScript output",lang:F?"lua":"typescript",errors:w,prismTheme:W})]})]})}function S({source:e,label:r,lang:t,onChange:i,prismTheme:o}){let u=(0,n.useRef)(null),m=(0,n.useRef)(null),p=(0,n.useRef)(null),d=(0,n.useMemo)(()=>Math.max(1,e.split("\n").length),[e]);return(0,a.jsxs)("div",{className:l,children:[(0,a.jsx)("div",{className:c,children:r}),(0,a.jsxs)("div",{className:"editorWrap_an2x",children:[(0,a.jsx)("div",{className:"editorGutter_NWp0",ref:p,"aria-hidden":!0,children:Array.from({length:d},(e,r)=>(0,a.jsx)("div",{className:"editorGutterLine_Exzz",children:r+1},r))}),(0,a.jsxs)("div",{className:"editorStack_zi6s",children:[(0,a.jsx)(s.f4,{code:e,language:t,theme:o,children:({className:e,style:r,tokens:t,getLineProps:n,getTokenProps:s})=>(0,a.jsx)("pre",{ref:m,className:`${e} editorOverlay_XNCf`,style:r,"aria-hidden":!0,children:t.map((e,r)=>(0,a.jsxs)("span",{...n({line:e}),children:[e.map((e,r)=>(0,a.jsx)("span",{...s({token:e})},r)),r<t.length-1&&"\n"]},r))})}),(0,a.jsx)("textarea",{ref:u,value:e,onChange:e=>i(e.target.value),onKeyDown:function(r){let t,a;if("Tab"!==r.key)return;r.preventDefault();let n=r.currentTarget,s=n.selectionStart,o=n.selectionEnd,l=e.slice(0,s);e.slice(s,o);let c=e.slice(o);if(s===o){i(l+"	"+c),requestAnimationFrame(()=>{n.selectionStart=n.selectionEnd=s+1});return}let u=l.lastIndexOf("\n")+1,m=e.slice(0,u),p=e.slice(u,o).split("\n");if(r.shiftKey){let e=0;t=p.map(r=>{if(r.startsWith("	"))return e+=1,r.slice(1);let t=r.match(/^ {1,4}/);return t?(e+=t[0].length,r.slice(t[0].length)):r}).join("\n"),a=-e}else t=p.map(e=>"	"+e).join("\n"),a=p.length;i(m+t+c),requestAnimationFrame(()=>{n.selectionStart=Math.max(u,s+(r.shiftKey?Math.min(0,a):1)),n.selectionEnd=o+a})},onScroll:function(){let e=u.current;e&&(p.current&&(p.current.scrollTop=e.scrollTop),m.current&&(m.current.scrollTop=e.scrollTop,m.current.scrollLeft=e.scrollLeft))},spellCheck:!1,className:"editor_TLlF","aria-label":r})]})]})]})}function A({output:e,label:r,lang:t,errors:n,prismTheme:s}){return(0,a.jsxs)("div",{className:l,children:[(0,a.jsx)("div",{className:c,children:r}),(0,a.jsx)(N,{source:e,lang:t,prismTheme:s}),n.length>0&&(0,a.jsx)("div",{className:"errors_GbBP",children:n.map((e,r)=>(0,a.jsxs)("div",{className:"errorRow_vLpB",children:[e.loc?`line ${e.loc.start.line+1}: `:"",e.message]},r))})]})}function P(){return(0,a.jsxs)("svg",{width:"22",height:"22",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,children:[(0,a.jsx)("path",{d:"M7 16V4M7 4L3 8M7 4l4 4"}),(0,a.jsx)("path",{d:"M17 8v12M17 20l-4-4M17 20l4-4"})]})}function N({source:e,lang:r,prismTheme:t}){return(0,a.jsx)(s.f4,{code:e,language:r,theme:t,children:({className:e,style:r,tokens:t,getLineProps:n,getTokenProps:s})=>(0,a.jsx)("pre",{className:`${e} output_KJb5`,style:r,children:t.map((e,r)=>(0,a.jsxs)("div",{...n({line:e}),children:[(0,a.jsx)("span",{className:"lineNum_BdmQ",children:r+1}),e.map((e,r)=>(0,a.jsx)("span",{...s({token:e})},r))]},r))})})}},4662(e,r,t){t.r(r),t.d(r,{default:()=>i});var a=t(1325),n=t(4825),s=t(1372);function i(){return(0,a.jsx)(s.A,{title:"Playground",description:"Compile Luau to TypeScript live, with native and roblox-ts compat modes.",children:(0,a.jsx)(n.A,{fallback:(0,a.jsx)("div",{style:{padding:"2rem"},children:"Loading playground\u2026"}),children:()=>{let e=t(6882).default;return(0,a.jsx)(e,{})}})})}}}]);